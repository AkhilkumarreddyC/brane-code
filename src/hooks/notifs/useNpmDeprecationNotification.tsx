...
const NPM_DEPRECATION_MESSAGE = 'Brane Code has switched from npm to native installer. Run `claude install` or see https://docs.anthropic.com/en/docs/brane-code/getting-started for more options.';
