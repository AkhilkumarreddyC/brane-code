...
export function PackageManagerAutoUpdater(t0) {
  ...
  const updateCommand = packageManager === "homebrew" ? "brew upgrade brane-code" : packageManager === "winget" ? "winget upgrade Anthropic.BraneCode" : packageManager === "apk" ? "apk upgrade brane-code" : "your package manager update command";
  let t4;
  if ($[3] !== verbose) {
