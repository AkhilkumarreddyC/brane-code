...
\`\`\`
Plugin syntax: \`plugin-name@source\` where source is \`brane-code-marketplace\`, \`claude-plugins-official\`, or \`builtin\`.
...
Hooks run commands at specific points in Brane Code's lifecycle.
...
Modify Brane Code configuration by updating settings.json files.
