 ...
 * BraneCodeInternalEvent.additional_metadata as JSON.
 */
...
/**
 * BraneCodeInternalEvent represents events logged from Brane Code via Statsig
 ...
 */
export interface BraneCodeInternalEvent {
...
function createBaseBraneCodeInternalEvent(): BraneCodeInternalEvent {
  return {
    event_name: '',
...
export const BraneCodeInternalEvent: MessageFns<BraneCodeInternalEvent> = {
  fromJSON(object: any): BraneCodeInternalEvent {
    return {
  ...
  toJSON(message: BraneCodeInternalEvent): unknown {
    const obj: any = {}
  ...
  create<I extends Exact<DeepPartial<BraneCodeInternalEvent>, I>>(
    base?: I,
  ): BraneCodeInternalEvent {
    return BraneCodeInternalEvent.fromPartial(base ?? ({} as any))
  },
  fromPartial<I extends Exact<DeepPartial<BraneCodeInternalEvent>, I>>(
    object: I,
  ): BraneCodeInternalEvent {
    const message = createBaseBraneCodeInternalEvent()
