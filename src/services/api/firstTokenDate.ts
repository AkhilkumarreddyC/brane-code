...
/**
 * Fetch the user's first Brane Code token date and store in config.
 * This is called after successful login to cache when they started using Brane Code.
 */
export async function fetchAndStoreBraneCodeFirstTokenDate(): Promise<void> {
  try {
