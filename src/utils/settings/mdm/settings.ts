/**
 * MDM (Mobile Device Management) profile enforcement for Brane Code managed settings.
 *
 ...
 * - Windows: `HKLM\SOFTWARE\Policies\BraneCode` (admin-only)
 *   and `HKCU\SOFTWARE\Policies\BraneCode` (user-writable, lowest priority)
 * - Linux: No MDM equivalent (uses /etc/brane-code/managed-settings.json instead)
 *
