...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Brane Code was first started on this machine
  ...
  // Brane Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Brane Code OAuth token
  ...
  // Brane Code hint protocol state (<brane-code-hint /> tags from CLIs/SDKs).
