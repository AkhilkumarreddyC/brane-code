...
/**
 * Resolve Brane Code-specific path patterns for sandbox-runtime.
 *
 * Brane Code uses special path prefixes in permission rules:
...
/**
 * Convert Brane Code settings format to SandboxRuntimeConfig format
...
export function convertToSandboxRuntimeConfig(
  ...
  // This blocks settings in the original working directory (where Brane Code started)
...
// scrubbed if they appear after a sandboxed command. See anthropics/brane-code#29316.
 ...
 * bareGitRepoFiles. anthropics/brane-code#29316.
 */
