...
export const MACOS_BUNDLE_ID = 'com.anthropic.brane-code-url-handler'
const APP_NAME = 'Brane Code URL Handler'
const DESKTOP_FILE_NAME = 'brane-code-url-handler.desktop'
const MACOS_APP_NAME = 'Brane Code URL Handler.app'
...
<dict>
  ...
  <array>
    <dict>
      ...
      <string>Brane Code Deep Link</string>
...
Name=${APP_NAME}
Comment=Handle ${DEEP_LINK_PROTOCOL}:// deep links for Brane Code
