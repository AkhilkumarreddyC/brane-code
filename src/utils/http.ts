...
import { getBraneCodeUserAgent } from './userAgent.js'
...
export function getMCPUserAgent(): string {
  ...
  return `brane-code/${MACRO.VERSION}${suffix}`
}
...
// operators match in robots.txt); the brane-code suffix lets them distinguish
// local CLI traffic from claude.ai server-side fetches.
export function getWebFetchUserAgent(): string {
  return `Claude-User (${getBraneCodeUserAgent()}; +https://support.anthropic.com/)`
}
