...
// Always ask when Brane Code tries to edit its own config files
 ...
 * This is a per-user temporary directory used by Brane Code for all temp files.
 *
 ...
 * - MCP CLI state files (managed internally by Brane Code)
